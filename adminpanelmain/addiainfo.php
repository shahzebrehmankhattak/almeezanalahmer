...
<h4 class="text-center text-white p-2">Add Incepection and Audit</h4>


<form class="p-4" id="addiainfo" method="post" action="insertiainfo.php">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="" name="offcername" style="height:42px">
  </div>
  <div class="mb-3">
