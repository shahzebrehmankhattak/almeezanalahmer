...
<div class="container">
   ...
   <a class="text-white" href="addcdinfo.php">Add New+</a>   
</button>
...
$q = "SELECT * FROM  centraldirectoraite";
...
Edit
</button>  <button class="btn" style="background-color:#9D6791;"><a class="text-white" href="deletecd.php?id=<?php echo $result ['id'];?> ">Delete</a>
