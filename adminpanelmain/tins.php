...
<div class="cointainer">
    <div class="row">
        <div class="col-lg-12">
            <h2 class="text-center" style="color:#6D376E">  Tins </h2>
        </div>
    </div>
</div>            
...
<div class="container">
   ...
   <a class="text-white" href="addtinsinfo.php">Add New+</a>   
</button>
...
Edit
</button>  <button class="btn" style="background-color:#9D6791;"><a class="text-white" href="deletetins.php?id=<?php echo $result ['id'];?> ">Delete</a>
