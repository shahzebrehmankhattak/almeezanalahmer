...
<div class="cointainer">
    <div class="row">
        <div class="col-lg-12">
            <h2 class="text-center" style="color:#6D376E">  Regional Directors </h2>
        </div>
    </div>
</div>            
...
<div class="container">
   ...
   <a class="text-white" href="addrdinfo.php">Add New+</a>   
</button>
...
$q = "SELECT * FROM  regionaldirector";
...
Edit
</button>  <button class="btn" style="background-color:#9D6791;"><a class="text-white" href="deleterd.php?id=<?php echo $result ['id'];?> ">Delete</a>
